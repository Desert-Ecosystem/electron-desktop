...
export function createSplashWindow(): void {
  ...
  const splashTexts = [
    ...
    'Desert существует в 3х агрегатных состояниях: Web-приложение, Настолькое приложение (Linux/Mac/Windows), Android приложение и самое загадочное состояние - IOS приложение, которое никто не видел...',
