...
export function createSplashWindow(): void {
  ...
  const splashTexts = [
    ...
    'Desert существует в 3х агрегатных состояниях: Web-приложение, Настолькое приложение (Linux/Mac/Windows), Android приложение и самое загадочное и самое мистическое состояние - IOS приложение, которое никто не видел...',
    'График разработки Desert крайне нерегулярный - делаем когда можем',
    'Бесплатный объем Desert Cloud составляет 1Gb. В будущем расширим, если цены на Enterprise SSD не расширят нам ... сами знаете что.',
    'Во всех приложениях Desert есть возможность выбрать цветовую схему и фон. Темы вдохновлены просьбами людей. Если есть идеи - создайте тикет в меню поддержки!',
